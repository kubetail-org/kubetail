...
export type LogFeedContentProps = {
  items: [number, number, number, number, number, number, number][];
  fetchMore: () => Promise<void>;
  hasMore: boolean;
}

export const LogFeedContent = ({ items, fetchMore, hasMore }: LogFeedContentProps) => {
  const [colWidths ] = useState([100, 300, 300, 300, 300, 300, 300]);
