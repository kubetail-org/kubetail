...
type LogRecordsStreamRequest struct {
	...
	// Maximum number of bytes to read per message. Messages longer than
	// this will be truncated. If 0 or negative, no truncation is applied.
	TruncateAtBytes uint64 `protobuf:"varint,9,opt,name=truncate_at_bytes,json=truncateAtBytes,proto3" json:"truncate_at_bytes,omitempty"`
	// Return only the logs with original message sizes greater than this
	// number of bytes
	MinOriginalSizeBytes uint64 `protobuf:"varint,10,opt,name=min_original_size_bytes,json=minOriginalSizeBytes,proto3" json:"min_original_size_bytes,omitempty"`
	// Return only the logs with original message sizes less than this
	// number of bytes
	MaxOriginalSizeBytes uint64 `protobuf:"varint,11,opt,name=max_original_size_bytes,json=maxOriginalSizeBytes,proto3" json:"max_original_size_bytes,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *LogRecordsStreamRequest) GetTruncateAtBytes() uint64 {
	if x != nil {
		return x.TruncateAtBytes
	}
	return 0
}

func (x *LogRecordsStreamRequest) GetMinOriginalSizeBytes() uint64 {
	if x != nil {
		return x.MinOriginalSizeBytes
	}
	return 0
}

func (x *LogRecordsStreamRequest) GetMaxOriginalSizeBytes() uint64 {
	if x != nil {
		return x.MaxOriginalSizeBytes
	}
	return 0
}
...
type LogRecord struct {
	...
	// The log message content (possibly truncated)
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	// The size of the message before truncation (in bytes)
...
const file_cluster_agent_proto_rawDesc = "" +
	...
	"\x06object\x18\x02 \x01(\v2\x1a.cluster_agent.LogMetadataR\x06object\"\xc2\x03\n" +
	...
	"followFrom\x12*\n" +
	"\x11truncate_at_bytes\x18\t \x01(\x04R\x0ftruncateAtBytes\x125\n" +
	"\x17min_original_size_bytes\x18\n" +
	" \x01(\x04R\x14minOriginalSizeBytes\x125\n" +
	"\x17max_original_size_bytes\x18\v \x01(\x04R\x14maxOriginalSizeBytes\"\xb2\x01\n" +
	"\tLogRecord\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12.\n" +
	"\x13original_size_bytes\x18\x03 \x01(\x04R\x11originalSizeBytes\x12!\n" +
	"\fis_truncated\x18\x04 \x01(\bR\visTruncated*,\n" +
	"\n" +
	"FollowFrom\x12\b\n" +
