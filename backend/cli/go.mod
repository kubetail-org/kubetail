module github.com/kubetail-org/kubetail/backend/cli

go 1.22.7

replace github.com/kubetail-org/kubetail/backend/server => ../server
...
require (
	...
	github.com/kubetail-org/kubetail/backend/server v0.0.0-00010101000000-000000000000
