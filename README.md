...
Kubetail is a Kubernetes logging dashboard that lets you view multiple log streams simultaneously, in real-time (runs as webapp on desktop or in cluster)
