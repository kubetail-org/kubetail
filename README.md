...
To install the `kubetail` CLI tool you can download it from the [release binaries](https://github.com/kubetail-org/kubetail/releases/latest) or install it from Homebrew:
