...
**Kubetail** is a general-purpose logging dashboard for Kubernetes, optimized for tailing across across multi-container workloads in real-time. With Kubetail, you can view logs from all the containers in a workload (like a Deployment or DaemonSet) in a single, beautifully organized timeline - in real-time.
